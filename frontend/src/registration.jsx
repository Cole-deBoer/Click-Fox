...
*/
export const handleRegister = async (e, username = '', email = '', verifyEmail = '', password = '', verifyPassword = '', navigate = (route) => {}) => {
    e.preventDefault();
    ...
    try {
        ...
        await createUser(username, email, firebaseUid, true);
...
*/
export const handleSignIn = async (e, email = '', password = '', navigate = (route) => {}) => {
    e.preventDefault();
    try {
...
*/
export const handleGoogleSignIn = async (setGoogleAuthUserData = ({stringUid, stringEmail}) => {}, shouldDisplayModal = (boolean) => {}, navigate = (route) => {}) => {
